defmodule ZoniaWeb.UserSocket do
  ...
  An invalid (non-empty) key is rejected at the socket layer; the client
  treats this as "your local identity is dead, wipe it and re-register."
  """
  use Phoenix.Socket
